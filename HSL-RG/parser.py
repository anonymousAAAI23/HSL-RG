...
def get_parser(root_dir='.'):
    ...
    parser.add_argument("--mlp-lr", type=float, default=0.001, # 0.003, 0.001, 0.0006
                        help="Training: Meta learning rate") 
    ...
    ## relation graph
    parser.add_argument("--aug-num", type=int, default=2, help="number of graph augmentation")  # 32
    parser.add_argument("--drop-ratio", type=float, default=0.1, help="edge/node drop ratio")  # 32
    parser.add_argument("--consi", type=float, default=1, help="number of graph augmentation")
    parser.add_argument("--aug", type=str, default="RE", help="augmentation type: remove nodes or remove edges")  # 32
    ...
    parser.add_argument("--node-n-layer", type=int, default=2, help="number of layers for gine")  # 3
    ...
    ## loss term
    ### adjacency reg
    parser.add_argument('--reg_adj', type=float, default=0, help='reg adj loss weight')
